...
#'
#' @param configuration_name character(1) name of the workflow, form
#'     `avworkflows()`.
#'
...
#' \dontrun{
#' config <-
#'     avworkflow_configuration_get("bioconductor-rpci-anvil", "AnVILBulkRNASeq")
#' }
#'
#' @export
...
{
    .Deprecated("avworkflow_configuration_set")
