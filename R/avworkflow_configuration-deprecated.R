#' @rdname avworkflow_configuration-deprecated
#' @name avworkflow_configuration-deprecated
#' @aliases avworkflow_configurations
#'
#' @title Workflow configuration (DEPRECATED)
#'
    ...
    function(workflow_namespace = NULL)
{
    .life_cycle(
        newpackage = "AnVILGCP",
        cycle = "deprecated",
        title = "avworkflow_configuration"
    )
